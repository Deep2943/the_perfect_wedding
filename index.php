...
<div id="content" class="no-bottom no-top">
    ...
    <!-- section begin -->
    <!-- <section id="section-hero" class="full-height relative z1 owl-slide-wrapper no-top no-bottom"
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right text-center-sm relative">
                                <b>
                                    <h2 class="name" style="color: purple">The</h2>
                                </b>
                            </div>
                            <div class="col-md-4 text-center">
                                <b>
                                    <h2 class="name" style="color: purple">Perfect</h2>
                                </b>
                            </div>
                            <div class="col-md-4 text-left text-center-sm relative">
                                <b>
                                    <h2 class="name" style="color: purple">Wedding</h2>
                                </b>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row wow fadeInUp">
                <div class="col-md-8 col-md-offset-2">
                    <blockquote class="very-big text-dark wow fadeIn">
                        "Make your wedding perfect with our planning. Forget the stress of your wedding and hire the
                        best wedding organizers."
                    </blockquote>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <form class="form-underline" method="POST" action="feedback.php">
                ...
                <div class="row-md-2">
                    Feedback: <textarea id="feedback" name="feedback" placeholder="feedback"
