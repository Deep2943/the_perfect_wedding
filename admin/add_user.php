                ...
                <div class="inner bg-container">
                    <div class="card">
                        ...
                        <div class="card-body m-t-35">
                            ...
                            <form class="form-horizontal login_validator" id="tryitForm" action="../register.php" method="post">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="uaddress"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="uphone" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="uemail" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
