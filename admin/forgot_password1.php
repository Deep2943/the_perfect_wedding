...
<!-- Mirrored from demo.admireadmin.com/admire_html/forgot_password1.html by HTTrack Website Copier/3.x [XR&CO'2010], Fri, 14 Dec 2018 11:26:57 GMT -->
<head>
                ...
                <div class="col-lg-4 col-sm-8 col-md-6 mx-auto forgotpwd_margin ">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-center">
                            <img src="img/logow2.png" alt="josh logo" class="admire_logo"><span class="text-white"> ADMIN &nbsp;<br/>
                    ...
                    <form action="http://demo.admireadmin.com/admire_html/login1.html" id="login_validator1" method="post"
                        ...
                        <div class="bg-white login_content login_border_radius">
                            <div class="form-group">
                                <label for="email_modal">Please enter your email to reset the password
                                </label>
                                <div class="input-group">
                            <span class="input-group-addon addon_email">
                            ...
                            <div class="form-group form-actions">
                                <button type="submit" class="btn btn-primary submit_email login_button" onclick="window.location.href='login1.php'">Submit
                                </button>
                            </div>
                        </div>
                    </form>
...
<!-- Mirrored from demo.admireadmin.com/admire_html/forgot_password1.html by HTTrack Website Copier/3.x [XR&CO'2010], Fri, 14 Dec 2018 11:26:58 GMT -->
</html>