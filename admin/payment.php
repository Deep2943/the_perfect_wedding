                ...
                <div class="main-bar">
                    ...
                    <div class="col-lg-6 col-sm-8">
                        <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                            ...
                            <li class="breadcrumb-item">Payment Table</li>
                        </ol>
                    </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <table id="example" class="table display nowrap" >
                                ...
                                <td><a class="edit" data-toggle="tooltip" data-placement="top"    title="Edit" href="edit_user.php?id=<?php echo $result['pay_id'] ?>">
                                    ...
                                    <a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="Delete" href="pay_delete.php?id=<?php echo $result['pay_id'] ?>">
