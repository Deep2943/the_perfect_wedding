                ...
                <div class="main-bar">
                    ...
                    <div class="col-lg-6 col-sm-8">
                        <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                            ...
                            <li class="breadcrumb-item">Decoration Table</li>
                        </ol>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="table-toolbar">
                                <div class="btn-group">
                                    <a href="add_decor.php" id="editable_table_new" class=" btn btn-default">Add Decor  <i class="fa fa-plus"></i>
                                    </a>
                                </div>
                            ...
                            <table id="example" class="table display nowrap" >
                                ...
                                <td><a class="edit" data-toggle="tooltip" data-placement="top"    title="Edit" href="edit_user.php?id=<?php echo $result['decor_id'] ?>">
                                    ...
                                    <a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="Delete" href="decor_delete.php?id=<?php echo $result['decor_id'] ?>">
