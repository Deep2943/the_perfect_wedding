                        ...
                        <div class="col-lg-6">
                            <div class="float-right">
                                <ol class="breadcrumb nav_breadcrumb_top_align">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="#">Decoration Table</a>
                                    </li>
                                    <li class="breadcrumb-item active">Add Decor</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="inner bg-container">
                    <div class="card">
                        ...
                        <div class="card-body m-t-35">
                            <div>
                                <h4>Decor Information</h4>
                            </div>
                            <form class="form-horizontal login_validator" id="tryitForm" action="decor_add_con.php" method="post">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="daddress"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="dphone" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
