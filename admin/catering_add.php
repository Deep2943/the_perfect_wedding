                        ...
                        <div class="col-lg-6">
                            <div class="float-right">
                                <ol class="breadcrumb nav_breadcrumb_top_align">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="#">Catering Table</a>
                                    </li>
                                    <li class="breadcrumb-item active">Add Caterors</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="caddress"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " name="cphone" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
